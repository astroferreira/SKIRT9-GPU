...
public:
    ...
    /** This function calculates the cdf() normalization factors for a batch of star-forming
        region parameter vectors, using the GPU backend if available. */
    ...
    /** This function samples wavelengths and normalized specific luminosities for a batch of
        star-forming region parameter vectors, using the GPU backend if available. */
